...
/***/ function(module, exports, __webpack_require__) {
	...
	var json2str = __webpack_require__(10);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js?minimize!./sole.css", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js?minimize!./sole.css");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "#sole{font-size:12px;max-width:640px;width:100%;max-height:300px;overflow-x:hidden;margin:0 auto;padding:5px;position:fixed;top:3%;z-index:999;background:#333;color:#fff;border:1px solid #ccc;word-wrap:break-word}#sole a{color:#fff;text-decoration:none}#sole .debugger-text-error{color:red}#sole .debugger-text-warn{color:#8a6d3b}#sole .debugger-text-info{color:#31708f}#sole .debugger-item{display:block;clear:both;position:relative;padding-right:5em}.debugger-btn{display:inline-block;border:1px solid #ccc;padding:0 5px}.debugger-remove{position:absolute;right:15px;top:0}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js?minimize!./agate.css", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js?minimize!./agate.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports) {
	...
	module.exports = "<div id=\"sole\" style=\"display: none\" v-show=\"messages.length\">\r\n    <div>\r\n        <a\r\n                href=\"javascript:;\"\r\n                v-if=\"messages.length\"\r\n                class=\"debugger-btn\"\r\n                @click=\"removeAllMessage\">clear</a>\r\n        <!--拖动可移动位置-->\r\n    </div>\r\n    <div\r\n            v-for=\"item in messages\"\r\n            track-by=\"$index\"\r\n            class=\"debugger-item debugger-item-{{item.type}}\">\r\n        <pre><code class=\"javascript\" v-html=\"item | preview | highlight\"></code></pre>\r\n        <a\r\n                href=\"javascript:;\"\r\n                class=\"debugger-btn debugger-remove\"\r\n                @click=\"removeMessage($index)\">remove</a>\r\n    </div>\r\n</div>";

/***/ }
/******/ ]);
//# sourceMappingURL=sole.js.map